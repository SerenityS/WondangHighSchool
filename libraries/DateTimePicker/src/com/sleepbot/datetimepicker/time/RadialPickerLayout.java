...
public class RadialPickerLayout extends FrameLayout implements OnTouchListener {
    ...
    public RadialPickerLayout(Context context, AttributeSet attrs) {
        ...
        mGrayBox.setVisibility(INVISIBLE);
        addView(mGrayBox);
    ...
    public void setCurrentItemShowing(int index, boolean animate) {
        ...
        if (animate && (index != lastIndex)) {
            ...
            if (Build.VERSION.SDK_INT >= 11) {
                ...
                int hourVisibility = (index == HOUR_INDEX) ? VISIBLE : INVISIBLE;
                int minuteVisibility = (index == MINUTE_INDEX) ? VISIBLE : INVISIBLE;
    ...
    public boolean trySettingInputEnabled(boolean inputEnabled) {
        ...
        mGrayBox.setVisibility(inputEnabled ? INVISIBLE : VISIBLE);
        return true;
    }
